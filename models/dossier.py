...
class Dossier(models.Model):
    ...
    num_dossier = fields.Char(string='Numéro de dossier', readonly=True, copy=False)
    ...
    def create(self, vals):
        if not vals.get('num_dossier'):
            ...
            last_dossier = self.search([('num_dossier', 'ilike', f'D{year_suffix}-%')], order='num_dossier desc', limit=1)
